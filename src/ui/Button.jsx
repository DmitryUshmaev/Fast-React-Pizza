...
function Button({ disabled, to, type, onClick, children }) {
  ...
  const styles = {
    ...
    secondary:
      'px-4 py-2.5 md:px-6 md:py-3.5 inline-block rounded-full text-sm focus:text-stone-800 border-2 border-stone-300 font-semibold uppercase tracking-wide text-stone-400 transition-colors duration-300 hover:bg-stone-300 hover:text-stone-800 focus:bg-yellow-300 focus:outline-none focus:ring focus:ring-stone-200 focus:ring-offset-2 disabled:cursor-not-allowed ',
  };
